...
public class EnrollmentDaoImpl implements EnrollmentDao {
	...
	public EnrollmentDaoResponse createEnrollment(EnrollmentDaoRequest enrollmentDaoRequest) throws BusinessException, SystemException  {
		logger.debug("Enter into EnrollmentSimpleJDBCDaoImpl--start");
		...
		/*	Class.forName("oracle.jdbc.driver.OracleDriver");
			...
			*/
			...
			String ACK_NUM_OUT=getAckNumber();
		...
		logger.info("Exit from EnrollmentSimpleJDBCDaoImpl--end "+daoResponse);
		return daoResponse;
	}
	/**String
	 * @return
